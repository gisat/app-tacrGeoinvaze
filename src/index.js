...
Store.dispatch(
    Action.components.set('tacrGeoinvaze_CaseSelectContent', 'showIntro', true)
);
...
Store.dispatch(
    ...
    if (latestPeriodInArray && latestPeriodInArray[0])
        Store.dispatch(Action.periods.setActiveKey(latestPeriodInArray[0].key));
});
                ...
                <ConnectedRouter history={history}>
                    <>
                        <Route
                            path={
                                path +
                                '/:caseKey?/:layerTemplateKey?/:periodKey?'
                            }
                            component={App}
                        />
                    </>
