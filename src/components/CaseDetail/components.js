...
export const Title = (props) => (
	<div className="tacrGeoinvaze-case-detail-title">
		{props.name}
		{props.nameSynonyms ? `/${props.nameSynonyms}` : null} <br />
		<i>
			{props.latinName}
			{props.latinNameSynonyms ? <>/{props.latinNameSynonyms}</> : null}
		</i>
	</div>
);
...
export const CaseImage = (props) => (
	<div className="tacrGeoinvaze-case-detail-image">
		...
		<div className="tacrGeoinvaze-case-image-copyright">
			{props.copyright}
		</div>
	</div>
);
...
export const Summary = (props) => (
	<div className="tacrGeoinvaze-case-detail-summary">{props.children}</div>
);

export const SummaryItem = (props) => (
	<div className="tacrGeoinvaze-case-detail-summary-item">
		<div className="tacrGeoinvaze-case-detail-summary-item-title">
			{props.title}
		</div>
		<div className="tacrGeoinvaze-case-detail-summary-item-value">
			{props.text}
		</div>
	</div>
);
...
export const TextBlock = (props) => (
	<div className="tacrGeoinvaze-case-detail-text">{props.children}</div>
);

export const InvasivePotential = (props) => (
	<div className="tacrGeoinvaze-case-detail-ip">
		<div className="tacrGeoinvaze-case-detail-ip-title">
			Invazivní potenciál
		</div>
		{props.children}
	</div>
...
export const SexualReproduction = (props) => (
	<InvasivePotentialCategoryWithRating
		name="Rozmnožování pohlavní"
		score={props.score}
	/>
);
...
export const EnvironmentImpact = (props) => (
	<InvasivePotentialCategoryWithRating
		name="Dopad na životní prostředí"
		score={props.score}
	/>
);

export const ManagementMethod = (props) => (
	<InvasivePotentialCategoryWithValue
		name="Management metoda"
		text={props.text}
	/>
);
...
export const InvasivePotentialCategoryWithRating = (props) => (
	<div className="tacrGeoinvaze-case-detail-ip-category">
		<div className="tacrGeoinvaze-case-detail-ip-category-name">
			{props.name}
		</div>
		<InvasivePotentialRating
			score={props.score}
			total={props.total ? props.total : 3}
		/>
	</div>
);
...
export const InvasivePotentialRating = (props) => {
	...
	for (let i = 1; i <= props.total; i++) {
		...
		content.push(<div key={i} className={classes}></div>);
	}
...
export const InvasivePotentialValue = (props) => {
	return (
		<div className="tacrGeoinvaze-case-detail-ip-value">{props.text}</div>
	);
};
